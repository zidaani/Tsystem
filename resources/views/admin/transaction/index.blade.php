            ...
            <form class="form-horizontal" action="{{route('agents.store')}}" method="POST">
              @csrf
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="branch"  class="form-control" id="inputEmail3" placeholder="hometown" value="{{old('branch')}}">
                    @error('branch')
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="first_name" class="form-control" id="inputEmail3" placeholder="first name" value="{{old('first_name')}}">
                    @error('first_name')
                        <span class="invalid-feedback text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
